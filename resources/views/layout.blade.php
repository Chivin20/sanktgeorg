...
<head>
    ...
    <link rel="shortcut icon" href="{{url('/assets/img/SANKTGEORGE.png')}}" />
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="/"><img src="{{url('/assets/img/SANKTGEORGEWHITE.jpg')}}" height="50px" width="50px" alt="logo"></a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="{{route('aboutus')}}" routerLink="/aboutus" routerLinkActive="active" >About Us</a></li>
              <li><a class="dropdown-item" href="{{route('staff')}}" routerLink="/staff" routerLinkActive="active" >Adminstration</a></li>
              <li><a class="dropdown-item" href="{{route('facilities')}}" routerLink="/facilities" routerLinkActive="active" >Facilities</a></li>
            </ul>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-md-0 mt-3">
          ...
          <div class="wrapingimage">   
            <img src="{{url('/assets/img/SANKTGEORGE.png')}}" height="80px" width="80px" alt="logo">    
            </div>   
